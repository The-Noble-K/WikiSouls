...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { body: @weapon.body, image_url: @weapon.image_url, skill: @weapon.skill, title: @weapon.title } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { body: @weapon.body, image_url: @weapon.image_url, skill: @weapon.skill, title: @weapon.title } }
